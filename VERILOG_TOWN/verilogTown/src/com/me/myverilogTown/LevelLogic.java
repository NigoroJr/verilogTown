...
public class LevelLogic
{
	...
	public LevelLogic()
	{
		...
		/* initialize cars */
		cars[0] = new Car(clevel.grid[7][0], clevel.grid[4][21], 1, clevel,null,0,0,0,0);
		cars[1] = new Car(clevel.grid[15][0], clevel.grid[4][21], 1, clevel,null,0,0,0,0);
		cars[2] = new Car(clevel.grid[21][9], clevel.grid[4][21], 1, clevel,null,0,0,0,0);
		cars[3] = new Car(clevel.grid[21][14], clevel.grid[14][0], 2, clevel,null,0,0,0,0);
		cars[4] = new Car(clevel.grid[3][21], clevel.grid[14][0], 2, clevel,null,0,0,0,0);
		cars[5] = new Car(clevel.grid[17][21], clevel.grid[14][0], 2, clevel,null,0,0,0,0);
		cars[6] = new Car(clevel.grid[7][0], clevel.grid[4][21], 3, clevel,null,0,0,0,0);
		cars[7] = new Car(clevel.grid[15][0], clevel.grid[14][0], 3, clevel,null,0,0,0,0);
		cars[8] = new Car(clevel.grid[21][9], clevel.grid[14][0], 4, clevel,null,0,0,0,0);
		cars[9] = new Car(clevel.grid[21][14], clevel.grid[18][21], 4, clevel,null,0,0,0,0);
	}
			...
			if (!cars[i].get_is_done_path())
			{
				...
				else if (cars[i].get_start_time() < time_step)
				{
					...
					else
					{
						...
						Gdx.app.log("LevelLogic", "Car="+ i +" At x="+ x +" y="+ y);
					}
