...
{
    /*
     * Assume grid size is 1 larger on all edges to accommodate invisible
     * starting points
     */
    private int grid_x;
    private int grid_y;
            ...
            VerilogTownGridNode end)
    {
        ...
        while ((current = queue.poll()) != null)
        {
            ...
            if (current.getNorth() != null
                    && !current.getNorth().isAlreadyVisited(markPathCount))
            {
    ...
    void verilogTownMapHardCode_first_map()
    {
        ...
        /*
         * Traffic signals in order of top left down to bottom right - the
         * current organization is where a grid point is going to...
         */
        this.traffic_signals[0].init_esw_traffic_signal(this.grid[3][21],
                this.grid[5][20], this.grid[2][19]);
        this.traffic_signals[1].init_wne_traffic_signal(this.grid[9][18],
                this.grid[10][20], this.grid[7][19]);
        this.traffic_signals[2].init_swn_traffic_signal(this.grid[18][18],
                this.grid[17][21], this.grid[16][19]);
        this.traffic_signals[3].init_nes_traffic_signal(this.grid[2][12],
                this.grid[1][15], this.grid[3][13]);
        this.traffic_signals[4].init_esw_traffic_signal(this.grid[8][14],
                this.grid[10][14], this.grid[7][13]);
        this.traffic_signals[5].init_fourway_traffic_signal(this.grid[18][12],
                this.grid[17][15], this.grid[19][14], this.grid[16][13]);
        this.traffic_signals[6].init_nes_traffic_signal(this.grid[2][7],
                this.grid[1][10], this.grid[3][9]);
        this.traffic_signals[7].init_wne_traffic_signal(this.grid[13][7],
                this.grid[14][9], this.grid[11][8]);
        this.traffic_signals[8].init_esw_traffic_signal(this.grid[17][10],
                this.grid[18][9], this.grid[16][8]);
        this.traffic_signals[9].init_nes_traffic_signal(this.grid[13][4],
                this.grid[12][7], this.grid[14][6]);
        this.traffic_signals[10].init_wne_traffic_signal(this.grid[7][2],
                this.grid[8][4], this.grid[5][3]);
        ...
        this.grid[3][20]
                .set_INTER_TURN_S2WS(this.grid[2][20], this.grid[3][19]);
        this.grid[4][20]
                .set_INTER_TURN_W2NW(this.grid[4][21], this.grid[3][20]);
        ...
        this.grid[17][20].set_INTER_TURN_S2WS(this.grid[16][20],
                this.grid[17][19]);
        this.grid[18][20].set_INTER_TURN_W2NW(this.grid[18][21],
                this.grid[17][20]);
        /* row 19 */
        ...
        this.grid[4][19]
                .set_INTER_TURN_N2EN(this.grid[5][19], this.grid[4][20]);
        ...
        this.grid[8][19]
                .set_INTER_TURN_E2SE(this.grid[8][18], this.grid[9][19]);
        this.grid[9][19].set_INTER_TURN_N2EN(this.grid[10][19],
                this.grid[9][20]);
        ...
        this.grid[17][19].set_INTER_TURN_E2SE(this.grid[17][18],
                this.grid[18][19]);
        ...
        this.grid[2][14]
                .set_INTER_TURN_W2NW(this.grid[2][15], this.grid[1][14]);
        ...
        this.grid[8][14]
                .set_INTER_TURN_S2WS(this.grid[7][14], this.grid[8][13]);
        this.grid[9][14]
                .set_INTER_TURN_W2NW(this.grid[9][15], this.grid[8][14]);
        ...
        this.grid[17][14].set_INTER_TURN_S2WS(this.grid[16][14],
                this.grid[17][13]);
        this.grid[18][14].set_INTER_TURN_W2NW(this.grid[18][15],
                this.grid[17][14]);
        ...
        /* row 13 */
        this.grid[1][13]
                .set_INTER_TURN_E2SE(this.grid[1][12], this.grid[2][13]);
        this.grid[2][13]
                .set_INTER_TURN_N2EN(this.grid[3][13], this.grid[2][14]);
        ...
        this.grid[9][13].set_INTER_TURN_N2EN(this.grid[10][13],
                this.grid[9][14]);
        ...
        this.grid[17][13].set_INTER_TURN_E2SE(this.grid[17][12],
                this.grid[18][13]);
        this.grid[18][13].set_INTER_TURN_N2EN(this.grid[19][13],
                this.grid[18][14]);
        ...
        this.grid[12][9]
                .set_INTER_TURN_S2WS(this.grid[11][9], this.grid[12][8]);
        ...
        this.grid[17][9]
                .set_INTER_TURN_S2WS(this.grid[16][9], this.grid[17][8]);
        this.grid[18][9].set_INTER_TURN_W2NW(this.grid[18][10],
                this.grid[17][9]);
        ...
        this.grid[12][8]
                .set_INTER_TURN_E2SE(this.grid[12][7], this.grid[13][8]);
        this.grid[13][8].set_INTER_TURN_N2EN(this.grid[14][13],
                this.grid[13][9]);
        ...
        this.grid[18][8]
                .set_INTER_TURN_N2EN(this.grid[19][8], this.grid[18][8]);
        ...
        this.grid[13][6]
                .set_INTER_TURN_W2NW(this.grid[13][7], this.grid[12][6]);
        ...
        this.grid[12][5]
                .set_INTER_TURN_E2SE(this.grid[12][4], this.grid[13][5]);
        this.grid[13][5]
                .set_INTER_TURN_N2EN(this.grid[14][5], this.grid[13][6]);
