...
public class ParseListener extends Verilog2001BaseListener 
{
	...
	public ParseListener (Verilog2001Parser parser, ArrayList<ParsePort> ports_list, ArrayList<ParseRegWire> vars_list, Hashtable<String, ParsePort> hash_ports, Hashtable<String, ParseRegWire> hash_vars)
	{
...
/* -------------------------------------------------------------------------------------	
----------------------------------------------------------------------------------------	
These are listeners to add inputs (wires or reg)
----------------------------------------------------------------------------------------	
--------------------------------------------------------------------------------------*/	
	@Override 
	public void enterNet_declaration(Verilog2001Parser.Net_declarationContext ctx) 
	{ 
		/* This is a wire declaration such as and handles all of these: 
		   wire clk;
		   wire [1:0]a;
		   wire [4:0]a, b;
		   */
...
--------------------------------------------------------------------------------------*/	
	@Override 
	public void enterDecimal_number(Verilog2001Parser.Decimal_numberContext ctx) 
	{
		if (is_number)
		{
...
--------------------------------------------------------------------------------------*/	
	@Override 
	public void enterOUTPUT_DECLARATION_NO_REG(Verilog2001Parser.OUTPUT_DECLARATION_NO_REGContext ctx)
	{ 
		/* 
		   output clk;
		   output [1:0]a;
	...
	@Override 
	public void exitOUTPUT_DECLARATION_NO_REG(Verilog2001Parser.OUTPUT_DECLARATION_NO_REGContext ctx)
	{ 
		ParsePort new_var;
	...
	@Override 
	public void enterOUTPUT_DECLARATION_REG(Verilog2001Parser.OUTPUT_DECLARATION_REGContext ctx)
	{ 
		/* 
		   output reg clk;
		   output reg [1:0]a;
	...
	@Override 
	public void exitOUTPUT_DECLARATION_REG(Verilog2001Parser.OUTPUT_DECLARATION_REGContext ctx)
	{ 
		ParsePort new_port;
...
/* -------------------------------------------------------------------------------------	
----------------------------------------------------------------------------------------	
This listener is for identifiers...very common so turned on and off by parse points
----------------------------------------------------------------------------------------	
--------------------------------------------------------------------------------------*/	
	@Override 
...
/* -------------------------------------------------------------------------------------	
----------------------------------------------------------------------------------------	
These handle ranges in [ : ] returning only integers
----------------------------------------------------------------------------------------	
--------------------------------------------------------------------------------------*/	
	@Override 
...
/* -------------------------------------------------------------------------------------	
----------------------------------------------------------------------------------------	
Traverses all variables on left side and updates there status...removes outputs from var list and hash
----------------------------------------------------------------------------------------	
--------------------------------------------------------------------------------------*/	
	@Override 
